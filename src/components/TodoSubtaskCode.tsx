...
export default function SubtaskCode({ listStyle, task }: TodoSubTaskCodeProps) {
    ...
    return (
        <div 
            style={{
                position: listStyle === 'demureCode' ? 'relative' : undefined
            }}
        >
            {listStyle !== 'demureCode' ?
                <div
            ...
            <SyntaxHighlighter
                ...
                className={`m-0 px-0 ${listStyle !== 'demureCode' ? 'rounded-bottom' : 'rounded'}`}
                customStyle={{
